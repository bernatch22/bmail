 ...
 *
 * NOTE FOR STEP 2/DB: @bmail/db still carries its own private copy of
 * normalizeSubject and computeThreadId. Once this package builds, db should
 * import normalizeSubject from here and implement ThreadLookup over its rows
 * — do it when db is next touched, not from this step.
 */
 ...
 * store (in practice @bmail/db). Return null when nothing matches.
 */
