 ...
 *
 * Migrated from @shmail/db. Two deliberate changes, zero logic changes:
 ...
 *     @bmail/contract instead of being declared here.
 *
...
import type { MailboxInfo, MessageEnvelope, FullMessage } from '@bmail/contract';
import type { BmailDatabase } from './index.js';
...
/**
 * Normalize subject for threading: strip Re:, Fwd:, RE:, FW: prefixes, trim.
 * "Re: Re: Fwd: Hello" → "hello"
 *
 * Pure string logic — slated to move to @bmail/domain in step 3; the export
 * stays here until then so nothing imports deep paths.
 */
